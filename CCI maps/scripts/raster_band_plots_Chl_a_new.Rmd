...
```{r paths}
gc()
project_folder <- "F:/NetCDFs_CCI/out/selected/Volta/Chla/"
file_raster <- paste0(project_folder, "20160526_20200518_chla_mean.tif")
...
for (i_band in 1:n_bands){  
  ...
  subname <- paste0("Chl-a concentration. Lake Volta.")
...
# ggsave(plot = plot, filename = paste0(folder_out, name, ".png"), device = "png", width = 9.25, height = 8.25, dpi = 300) #Na_Lake_1659
